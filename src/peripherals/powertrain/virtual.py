...
class VirtualPowertrain(Powertrain):
    ...
    def move(self, destination):
        ...
        # destination és una tupla de x i y que indica a quin waypoint ha d'arribar el vehicle
        ...
        if y_final > y_actual:
            ...
            # pensar què fer en aquest cas (tant la x i la y són les mateixes a l'origen i al destí). Sortir?
